...
public class SymbolPickerTester extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i.putExtra(SymbolPickerActivity.supportedVersionsKey, new int[]{SymbolID.Version_APP6D, SymbolID.Version_2525Dch1, SymbolID.Version_2525E, SymbolID.Version_2525Ech1});
