...
import armyc2.c5isr.graphics2d.BufferedImage;
import armyc2.c5isr.graphics2d.Font;
import armyc2.c5isr.graphics2d.FontMetrics;
import armyc2.c5isr.graphics2d.FontRenderContext;
import armyc2.c5isr.graphics2d.Graphics2D;
import armyc2.c5isr.graphics2d.Line2D;
import armyc2.c5isr.graphics2d.PathIterator;
import armyc2.c5isr.graphics2d.Point;
import armyc2.c5isr.graphics2d.Point2D;
import armyc2.c5isr.graphics2d.Polygon;
...
public class Modifier2 {
    ...
    public static void AddModifiersGeo(TGLight tg,
        ...
        try {
            ...
            switch (tg.get_LineType()) {
                ...
                case TacticalLines.BIOT://APP6/E
                case TacticalLines.CHEM:
                case TacticalLines.CHEMT://APP6/E
                case TacticalLines.NUC:
                case TacticalLines.RAD:
                case TacticalLines.RADT://APP6/E
    ...
    private static Bitmap getImageModifier(TGLight tg) {
        String symbolID = tg.get_SymbolId();
        ImageInfo symbol = null;
        Map<String,String> mods = new HashMap<>();
        Map<String,String> sa = new HashMap<>();
        sa.put(MilStdAttributes.PixelSize, String.valueOf(tg.get_IconSize()));
        ...
        if (contaminationCode > 0) {
            ...
            contaminationSP = SymbolID.setHQTFD(contaminationSP, 0); // Remove dummy modifier if necessary
            symbol = SinglePointRenderer.getInstance().RenderSP(contaminationSP, mods, sa);
            ...
            if (tg.get_KeepUnitRation()) {
                sa.put(MilStdAttributes.PixelSize, String.valueOf((int) (tg.get_IconSize() * 1.5)));
            }
            sa.put(MilStdAttributes.OutlineSymbol, "true");
            symbol = SinglePointRenderer.getInstance().RenderModifier(symbolID, sa);
            ...
            String decisionPoint = SymbolID.setEntityCode(symbolID, EntityCode.EntityCode_Decision_Point);
            symbol = SinglePointRenderer.getInstance().RenderSP(decisionPoint, mods, sa);
        }
            ...
            symbol = SinglePointRenderer.getInstance().RenderSP(anchorPoint, mods, sa);
        }
