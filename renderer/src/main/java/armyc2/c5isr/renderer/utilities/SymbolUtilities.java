...
public class SymbolUtilities {
    ...
    /*public static String setSVGFrameColors(String symbolID, String svg, Color strokeColor, Color fillColor)
    {
        ...
        return setSVGFrameColors(symbolID, svg, hexStrokeColor,hexFillColor);
    }//*/
    ...
    public static Point getCMSymbolAnchorPoint(String symbolID, RectF bounds) {
        ...
        if (ss == SymbolID.SymbolSet_ControlMeasure) {
            ...
            {
                case DrawRules.POINT1://action points 1301 //bottom center
                ...
                case DrawRules.POINT4://drop point 2104 //almost bottom and center
                    ...
                    break;
                case DrawRules.POINT10://Sonobuoy 2135 //center of circle which isn't center of symbol
                    centerY = (bounds.height() * 0.75f);
                    break;
                case DrawRules.POINT13://booby trap 2807 //almost bottom and center
                    centerY = (bounds.height() * 0.74f);
                    break;
                case DrawRules.POINT15://Marine Life 2189 //center left
                    centerX = 0;
                    break;
